...
[role="lead"]
ONTAP scarica e aggiorna automaticamente firmware e file di sistema sul tuo sistema ASA r2 per impostazione predefinita. Se vuoi avere la flessibilità di visualizzare gli aggiornamenti consigliati prima che vengano scaricati e installati, puoi usare System Manager per disabilitare gli aggiornamenti automatici o per modificare i parametri di aggiornamento così da essere avvisato degli aggiornamenti disponibili prima che venga eseguita qualsiasi azione.
...
Gli aggiornamenti consigliati per il firmware dello storage, il firmware Service Processor/Baseboard Management Controller (SP/BMC) e i file di sistema vengono scaricati e installati automaticamente sul tuo sistema ASA r2 per impostazione predefinita. Se gli aggiornamenti automatici sono stati disabilitati, puoi riattivarli per ripristinare il comportamento predefinito.
...
Disattiva gli aggiornamenti automatici solo se desideri gestire gli aggiornamenti interamente in autonomia. Con gli aggiornamenti automatici disattivati, il sistema non notificherà, scaricherà o installerà aggiornamenti. Sei responsabile del monitoraggio, del download, della pianificazione e dell'installazione manuale di tutti gli aggiornamenti.
...
.Risultato
Gli aggiornamenti automatici sono disabilitati. Dovresti controllare regolarmente la presenza di aggiornamenti consigliati e decidere se vuoi eseguire un'installazione manuale.
...
Puoi scegliere di scaricare e installare automaticamente sul tuo cluster gli aggiornamenti consigliati per il firmware dello storage, il firmware SP/BMC e i file di sistema, oppure puoi scegliere di ignorare automaticamente gli aggiornamenti consigliati. Se vuoi controllare manualmente l'installazione o l'ignorare degli aggiornamenti, seleziona di essere avvisato quando è disponibile un aggiornamento consigliato; poi puoi scegliere manualmente se installarlo o ignorarlo.
