...
| Sistemi  a| 
I seguenti sistemi NetApp ASA r2 sono supportati a partire da ONTAP 9.16.1. Questi sistemi forniscono una soluzione hardware e software unificata che crea un'esperienza semplificata specifica per le esigenze dei clienti che utilizzano solo SAN.
...
| link:../learn-more/additional-supported-ontap-features.html#san-protocols["Deallocazione dello spazio NVMe abilitata per impostazione predefinita"]  a| 
