...
Il ripristino di un gruppo di coerenza sostituisce i dati in tutte le unità di storage del gruppo con i dati di uno snapshot. Le modifiche apportate alle unità di storage dopo la creazione dello snapshot non vengono ripristinate.
