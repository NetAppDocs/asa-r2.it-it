...
A partire da ONTAP 9.16.1, puoi usare System Manager per creare gruppi di coerenza gerarchici sul tuo sistema ASA r2. In una struttura gerarchica, uno o più gruppi di coerenza sono configurati come figli sotto un gruppo di coerenza padre.
