...
+
Formatta l'NQN dell'host come <nqn.yyyy-mm> seguito da un fully qualified domain name. L'anno deve essere uguale o successivo al 1970. La lunghezza massima totale deve essere 223. Un esempio valido di initiator NVMe è nqn.2014-08.com.example:string.
