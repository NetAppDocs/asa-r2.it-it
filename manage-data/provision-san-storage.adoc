...
---
= Esegui il provisioning dello storage SAN ONTAP sui sistemi ASA r2
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
A partire da ONTAP 9.19.1, se si crea una LUN AIX che si intende abilitare per la protezione della sincronizzazione attiva SnapMirror, in *Informazioni host*, selezionare *locale* per la *Modalità di accesso*. Questo è necessario per abilitare il failover trasparente delle applicazioni.
