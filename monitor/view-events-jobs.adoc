...
[role="lead"]
Utilizza ONTAP System Manager per visualizzare un elenco di errori o avvisi, azioni correttive consigliate, registri di controllo del sistema e processi attivi, completati o non riusciti.
...
.Risultato
L'indirizzo email che hai aggiunto riceve le notifiche email specificate per gli eventi del cluster e i log di controllo.
