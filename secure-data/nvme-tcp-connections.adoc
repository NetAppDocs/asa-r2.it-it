...
summary: Migliora la sicurezza dei tuoi dati configurando NVMe TCP su TLS per crittografare tutti i dati inviati sulla rete tra il tuo host NVMe TCP e ONTAP. 
---
...
. Seleziona image:icon_add_blue_bg.png["Quadrato blu con un segno più seguito dalla parola Aggiungi in lettere bianche"].
