...
Per passare dal gestore delle chiavi integrato a un gestore delle chiavi esterno o viceversa, vedere link:https://docs.netapp.com/us-en/ontap/encryption-at-rest/migrate-keys-between-key-managers["Eseguire la migrazione delle chiavi di crittografia dei dati ONTAP tra manager delle chiavi"^].
