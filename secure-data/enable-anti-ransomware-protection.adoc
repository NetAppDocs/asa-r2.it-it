...
È possibile abilitare ARP/AI per impostazione predefinita su tutte le unità di storage create in una macchina virtuale di storage (VM). Ciò significa che tutte le nuove unità di archiviazione create nella VM di archiviazione avranno ARP/AI abilitato automaticamente.  È anche possibile applicare ARP/AI alle unità di archiviazione esistenti nella VM di archiviazione.
...
Se non si desidera abilitare ARP/AI su tutte le unità di archiviazione in una VM di archiviazione, è possibile selezionare le unità specifiche che si desidera abilitare.
