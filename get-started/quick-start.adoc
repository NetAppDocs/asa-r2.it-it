...
[role="lead"]
Per iniziare a utilizzare il tuo sistema ASA r2, installa i componenti hardware, configura il cluster, imposta l'accesso ai dati dai client SAN al sistema storage e fornisci lo storage.
