...
[role="lead"]
I sistemi ASA r2 supportano un'ampia gamma di funzionalità SAN, ma alcune funzionalità del software ONTAP non sono supportate.
...
** SnapMirror la replica asincrona è supportata solo tra due sistemi ASA r2. SnapMirror la replica asincrona non è supportata tra un sistema ASA r2 e un sistema ASA, AFF o sistema FAS, oppure il cloud.
+
