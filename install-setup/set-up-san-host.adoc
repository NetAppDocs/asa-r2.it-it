...
L'illustrazione seguente è un esempio di una configurazione FC con più host che utilizzano due fabric per accedere a una singola coppia HA.  Anche i numeri delle porte di destinazione FC (0c, 0d, 1a, 1b) sono esempi.  I numeri di porta effettivi variano a seconda del modello del sistema e dell'eventuale utilizzo di adattatori di espansione.
